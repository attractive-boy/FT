<template>
  <view class="bg-gray-200 h-screen">
    <!-- 公告 -->
    <nut-noticebar
      text="欢迎使用 FT 汇报小程序，此处是公告信息位置，请超级管理员发布您的第一条公告！"
    />
    <!-- 俱乐部标题 -->
    <view
      class="w-auto rounded-md bg-white p-2 m-2 flex justify-between items-center"
    >
    ...
    <view class="w-auto m-2 flex justify-between items-center">
      <view
        class="w-1/2 aspect-ratio-5/3 bg-orange-500 mr-1 p-3 rounded-md flex justify-between items-start"
      ...
      <view
        class="w-1/2 aspect-ratio-5/2 bg-green-500 ml-1 p-3 rounded-md flex justify-between items-start"
    ...
    <!-- 俱乐部榜单 -->
    <view
      class="w-auto mx-2 bg-white p-3 flex justify-between items-center rounded-md"
    >
